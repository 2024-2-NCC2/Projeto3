...
import Alimentacao from './pages/Alimentacao.js';
import Acolhimento from './pages/Acolhimento.js';
import Educacao from './pages/Educacao.js';
import SaudeMental from './pages/SaudeMental.js';
import MaisServicos from './pages/MaisServicos.js';
